...
//  weishi
//
//  Created by owen on 15/7/21.
//  Copyright (c) 2015年 信帧. All rights reserved.
//

#ifndef weishi_MacroDefinition_h
#define weishi_MacroDefinition_h
//AppDelegate
#define ShowAlert(title) [[[UIAlertView alloc] initWithTitle:@"提示信息" message:title delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil, nil] show]

#define ShowAlertCancel(title) [[[UIAlertView alloc] initWithTitle:@"提示信息" message:title delegate:self cancelButtonTitle:@"确定" otherButtonTitles:@"取消", nil] show]
...
//Alert
#define ALERT(msg) [[[UIAlertView alloc] initWithTitle:nil message:msg delegate:nil cancelButtonTitle:@"取消" otherButtonTitles:nil] show]
...
#define PH4LoginBtn 58
#define PH5LoginBtn 146
#define PH6LoginBtn 245
#define PH6pLoginBtn 245

#define __TencentDemoAppid_  @"1104748300"

#define PreDefM_APPID @"FEppuNWhVnyZbCGu"
